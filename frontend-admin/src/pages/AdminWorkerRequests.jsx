...
import { FaCheckCircle, FaTimesCircle, FaArrowLeft, FaIdCard, FaFileAlt, FaUserTie } from "react-icons/fa";
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-sky-50 to-gray-100 flex items-center justify-center">
        <div className="flex flex-col items-center">
          ...
          <div className="text-lg text-sky-700">Loading worker applications...</div>
        </div>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-gradient-to-br from-sky-50 to-gray-100 p-6">
      <div className="max-w-6xl mx-auto">
        <div className="flex items-center mb-6">
          ...
          <h2 className="text-3xl font-bold text-sky-900">Pending Worker Applications</h2>
        </div>
        ...
        {error ? (
          ...
          <div className="bg-white rounded-xl shadow-md p-8 text-center">
            ...
            <p className="text-sky-700">All worker applications have been processed.</p>
          </div>
        ) : (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {workers.map((worker) => (
              <div key={worker._id} className="bg-white rounded-xl shadow-md overflow-hidden border border-gray-100 transform transition-all duration-300 hover:shadow-lg">
                <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-sky-400 to-blue-600"></div>
                <div className="p-6">
                  <div className="flex items-start justify-between mb-4">
                    <div className="w-12 h-12 bg-sky-100 rounded-full flex items-center justify-center">
                      <FaUserTie className="h-6 w-6 text-sky-600" />
                    </div>
                  ...
                  <div className="space-y-2 mb-4">
                    ...
                    <p className="text-sm text-gray-600">
                      <span className="font-medium w-24">Nationality:</span> {worker.nationality}
                    </p>
                  </div>
                  ...
                  <div className="flex justify-end gap-3 mt-4">
                    <button
                      onClick={() => handleStatusUpdate(worker._id, "verified")}
                    ...
                    <button
                      onClick={() => handleStatusUpdate(worker._id, "deleted")}
