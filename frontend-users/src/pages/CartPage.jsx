...
const CartPage = () => {
  ...
  const [expanded, setExpanded] = useState(false); // for mobile total container
      ...
      {loading ? (
        ...
        <div className="flex flex-col md:flex-row gap-6">
          ...
          <div className={`bg-white border border-lime-300 rounded-lg shadow-md flex-shrink-0 
            ...
            {/* Mobile: unchanged but add Total Amount heading */}
            {isMobile && (
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-2">
                    <button
                      ...
                      className="py-1 px-3 bg-lime-600 text-white rounded cursor-pointer hover:bg-lime-500 transition text-sm"
                    >
                      Checkout
                    </button>
                    <button
            ...
            {/* Desktop/Laptop: unchanged, keep original width and spacing */}
            {!isMobile && (
              <div>
                ...
                <button
                  onClick={handleCheckout}
                  className="w-full py-2 bg-lime-600 text-white cursor-pointer rounded-lg hover:bg-lime-500/75 hover:text-sky-900 transition"
                >
                  Checkout
                </button>
              </div>
