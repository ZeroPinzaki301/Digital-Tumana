  ...
  useEffect(() => {
    const fetchOrderDetails = async () => {
      try {
        ...
        const res = await axiosInstance.get(`/api/customer/order/ongoing/${orderId}`, {
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="space-y-6">
            {/* Delivery Status */}
            <div className="bg-white p-4 rounded-lg shadow-md border border-lime-300">
              <h3 className="text-lg font-semibold text-lime-800 mb-4">Delivery Information</h3>
              <div className="space-y-4">
                <div>
                ...
                <div>
                  ...
                  <p className={deliveryInfo.isDelivered ? "text-lime-600 font-medium" : "text-amber-600 font-medium"}>
                    {deliveryInfo.isDelivered ? "Delivered" : "On the way"}
                  </p>
                </div>
            ...
            {/* Rider Information */}
            <div className="bg-white p-4 rounded-lg shadow-md border border-lime-300">
              <h3 className="text-lg font-semibold text-lime-800 mb-4">Rider Information</h3>
              {riderInfo ? (
                <div className="space-y-4">
                  <div className="flex items-center gap-4">
                    <img
                ...
                <p className="text-gray-600">No rider assigned yet</p>
              )}
            </div>
...
export default OngoingOrderDetailsPage;